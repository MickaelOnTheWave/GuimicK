...
TEST_CASE_METHOD(ChkdskParserFixture, "doesnt crash when parsing invalid buffer")
{
   TestNoCrashOnInvalidBuffer();
}

TEST_CASE_METHOD(ChkdskParserFixture, "creates one drive report")
{
   const wstring buffer = L"The type of the file system is NTFS.\n"
                          ...
                          L"  3010 large file records processe&d.                                   \n"
                          L"\n"
