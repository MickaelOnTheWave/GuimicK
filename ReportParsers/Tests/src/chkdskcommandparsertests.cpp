...
TEST(ChkdskCommandParser, doesnt_crash_when_parsing_invalid_buffer)
{
...
TEST(ChkdskCommandParser, creates_one_drive_report)
{
   FAIL();
...
TEST(ChkdskCommandParser, creates_multiple_drive_report)
{
   FAIL();
   const wstring buffer = L"Sist.fichs      Tama  Ocup Livre Uso% Montado em\n"
